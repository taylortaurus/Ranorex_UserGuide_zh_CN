...
如果你的⇢[代理列表][1]为空，则⇢[远程面板][2]将显示远程欢迎屏幕。
...
为了将Ranorex代理添加到你的代理列表中，代理必须安装在网络中的一台计算机上。
从第1步开始找到下载安装包的链接。 在此查找有关安装Ranorex Agent的详细信息：[Ranorex代理的安装和设置][4]

一旦成功安装了Ranorex代理，或者你的网络中已经有多个代理正在运行，请继续执行第2步以管理你的代理列表。
按照此链接了解如何将代理添加到你的代理列表：[管理你的代理列表][5]

## 在你的代理列表里添加其他代理

如果你的代理列表中已经有代理，请点击远程面板右上角的图标来管理你的代理列表。
